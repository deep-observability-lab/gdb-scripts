...
def main(argv):
    ...
    parser.add_argument(
        ...
        type=str,
        default="/work",
        help='Directory where you should put all the shared-binaries/app-binary (and some source codes).')
    parser.add_argument(
        '-ui',
        '--user_interface',
        type=str,
